...
class DeclineCandidate extends Action
{
    /**
    ...
    public function execute(): ResultInterface
    {
        ...
        if ($candidateId) {
            try {
                $this->candidateManagement->decline((int)$candidateId);
                $this->messageManager->addSuccessMessage(
                    __('A Company Administrator change request has been declined.')
                );
                ...
                $this->messageManager->addExceptionMessage(
                    $exception,
                    __('Something went wrong while declining new Company Administrator request.')
                );
            }
