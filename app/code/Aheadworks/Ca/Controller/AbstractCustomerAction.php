...
abstract class AbstractCustomerAction extends Action
{
     ...
     */
    public const IS_ENTITY_BELONGS_TO_CUSTOMER = false;

    /**
     * AbstractCustomerAction Construct
     *
    ...
    {
        $awCaCompanyUser = $this->getCurrentCompanyUser()->getExtensionAttributes()->getAwCaCompanyUser();
        if ($awCaCompanyUser === null) {
            throw new NotFoundException(__('Page not found.'));
        }

        return $awCaCompanyUser->getCompanyId();
    }
