define([
    ...
    return Element.extend({
        ...
        isCascadeUpdateTriggered: false,
        clickedNodeParentCount: 0,
        ...
        _cascadeTree: function (e, data) {
            ...
            if (!this.initTree && data && data.node && data.action) {
                if (!this.isCascadeUpdateTriggered) {
                    this.clickedNodeParentCount = data.node.parents.length;
                    this.isCascadeUpdateTriggered = true;
                }
                if (this.isCascadeUpdateTriggered && this.clickedNodeParentCount > 2) {
                    return;
                }
        ...
        _updateValue: function () {
            ...
            this.isCascadeUpdateTriggered = false;
