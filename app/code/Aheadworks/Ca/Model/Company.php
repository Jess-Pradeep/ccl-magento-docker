...
class Company extends AbstractModel implements CompanyInterface
{
    ...
    {
        $shippingMethods = $this->getData(self::ALLOWED_SHIPPING_METHODS);
        return $this->hasData(self::ALLOWED_SHIPPING_METHODS) && is_array($shippingMethods)
            ? $shippingMethods
            : [];
    }
    ...
    {
        return $this->setData(self::ALLOWED_SHIPPING_METHODS, $allowedShippingMethods);
    }

    /**
     * Is shared addresses enabled
     *
     * @return bool
     */
    public function getIsSharedAddressesFlagEnabled(): bool
    {
        return (bool)$this->getData(self::IS_SHARED_ADDRESSES_FLAG_ENABLED);
    }

    /**
     * Set is shared addresses enabled
     *
    ...
    {
        return $this->setData(self::IS_SHARED_ADDRESSES_FLAG_ENABLED, $isSharedAddressesFlagEnabled);
    }
