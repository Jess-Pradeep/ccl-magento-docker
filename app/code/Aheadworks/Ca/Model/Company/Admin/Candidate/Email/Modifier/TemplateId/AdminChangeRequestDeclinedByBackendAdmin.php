...
namespace Aheadworks\Ca\Model\Company\Admin\Candidate\Email\Modifier\TemplateId;
...
class AdminChangeRequestDeclinedByBackendAdmin implements ModifierInterface
{
    /**
     * @param Config $config
     */
    ...
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        $emailMetadata->setTemplateId(
            $this->config->getChangeRequestDeclinedByBackendAdminTemplate(
