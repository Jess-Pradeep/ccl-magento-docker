 ...
 */
class Domain implements ModifierInterface
{
    /**
     * @inheritdoc
     */
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        ...
        $templateVariables[EmailVariables::COMPANY] = $relatedObjectList[ModifierInterface::COMPANY];
        $templateVariables[EmailVariables::DOMAIN] = $relatedObjectList[ModifierInterface::DOMAIN];
