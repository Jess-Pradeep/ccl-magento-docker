...
/**
 * Class NewCompanyUserAssignedForCompanyUser
 *
 * @package Aheadworks\Ca\Model\Customer\CompanyUser\Email\Modifier\TemplateId
 */
class NewCompanyUserAssignedForCompanyUser implements ModifierInterface
{
    /**
     * @var Config
     */
    ...
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        ...
        $emailMetadata->setTemplateId($this->config->getNewCompanyUserAssignedForCompanyUserTemplate($storeId));
