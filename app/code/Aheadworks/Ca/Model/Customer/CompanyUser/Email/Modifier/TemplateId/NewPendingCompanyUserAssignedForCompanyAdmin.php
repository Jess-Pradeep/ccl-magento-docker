...
/**
 * Class NewPendingCompanyUserAssignedForCompanyAdmin
 *
 * @package Aheadworks\Ca\Model\Customer\CompanyUser\Email\Modifier\TemplateId
 */
class NewPendingCompanyUserAssignedForCompanyAdmin implements ModifierInterface
{
    /**
     * @var Config
     */
    ...
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        ...
        $emailMetadata->setTemplateId($this->config->getNewPendingCompanyUserAssignedForCompanyAdminTemplate($storeId));
