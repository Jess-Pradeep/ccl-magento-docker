...
/**
 * Class NewPendingCompanyUserAssignedForCompanyUser
 *
 * @package Aheadworks\Ca\Model\Customer\CompanyUser\Email\Modifier\TemplateId
 */
class NewPendingCompanyUserAssignedForCompanyUser implements ModifierInterface
{
    /**
     * @var Config
     */
    ...
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        ...
        $emailMetadata->setTemplateId($this->config->getNewPendingCompanyUserAssignedForCompanyUserTemplate($storeId));
