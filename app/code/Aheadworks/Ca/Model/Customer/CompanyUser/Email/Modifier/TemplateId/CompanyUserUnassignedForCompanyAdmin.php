 ...
 */
class CompanyUserUnassignedForCompanyAdmin implements ModifierInterface
{
    /**
     * @var Config
     */
    ...
    public function addMetadata(EmailMetadataInterface $emailMetadata, array $relatedObjectList): EmailMetadataInterface
    {
        ...
        $emailMetadata->setTemplateId($this->config->getCompanyUserUnassignedForCompanyAdminTemplate($storeId));
