 ...
 */
class CompanyAdmin implements ModifierInterface
{
    /**
    ...
    {
        /** @var CompanyInterface $order */
        $company = $relatedObjectList[ModifierInterface::COMPANY];
        $emailMetadata->setRecipientEmail($this->recipientResolver->resolveCompanyAdminEmail($company));
        $emailMetadata->setRecipientName($this->recipientResolver->resolveCompanyAdminName($company));
