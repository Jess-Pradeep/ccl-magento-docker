...
class MagentoCustomerModel implements ProcessorInterface
{
    /**
    ...
    public function addCustomData(
        ...
        $companyUser = $this->companyUserProvider->getCompanyUserByCustomer($model->getId());
        if (!$companyUser) {
            return $object;
        }
