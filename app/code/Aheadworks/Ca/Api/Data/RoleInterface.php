...
interface RoleInterface extends ExtensibleDataInterface
{
    ...
    const ORDER_BASE_AMOUNT_LIMIT = 'order_base_amount_limit';
    /**#@-*/
    ...
    /**
     * Get order base amount limit
     *
     * @return float|null
     */
    public function getOrderBaseAmountLimit();

    /**
     * Set order base amount limit
     *
     * @param float|null $amount
     * @return $this
     */
    public function setOrderBaseAmountLimit($amount);
