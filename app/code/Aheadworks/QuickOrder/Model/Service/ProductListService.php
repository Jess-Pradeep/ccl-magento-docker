...
class ProductListService implements ProductListManagementInterface
{
    ...
    public function addItemsToList($listId, $itemsData, $storeId)
    {
        ...
        $productListItems = $this->mergeManager->mergeItems($newItems, $productListItems);
        if ($lastMergedItemKey = $this->mergeManager->getLastMergedItemKey()) {
            $operationResult->setLastAddedItemKey($lastMergedItemKey);
        }
