...
use Aheadworks\QuickOrder\Model\ProductList\Item\MergeManager;
...
class Processor
{
    ...
    public function update($itemKey, $requestItem, $operationResult, $storeId)
    {
        ...
        try {
            ...
            if ($preparedCandidateToMerge = $this->mergeManager->getPreparedCandidateToMerge($productListItem)) {
                $this->productListItemRepository->deleteById($productListItem->getItemId());
                $productListItem = $preparedCandidateToMerge;
                $operationResult->setLastAddedItemKey($preparedCandidateToMerge->getItemKey());
            }
