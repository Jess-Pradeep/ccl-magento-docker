...
class CustomOptionValue extends AbstractExtensibleModel implements CustomOptionValueInterface
{
    ...
    public function getOptionValue()
    {
        ...
        if ($this->getIsFile()) {
            $fileData = $this->getExtensionAttributes()
                ? $this->getExtensionAttributes()->getFileData()
                : null;
            if ($fileData instanceof CustomOptionFileInterface) {
                $value = $fileData->getData();
            }
        } else if ($value == 'file') {
    ...
    {
        return (bool) $this->getData(self::IS_FILE);
    }
    ...
    {
        return $this->setData(self::IS_FILE, $isFile);
    }
}
