...
class ProductListServiceTest extends TestCase
{
    ...
    /**
     * @var MergeManager|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $objectManager->getObject(
            ...
            [
                ...
                'mergeManager' => $this->mergeManagerMock
            ]
        );
    }
    ...
    public function testAddItemsToList()
    {
        ...
        $itemListResult = [$itemKey => $listItemMock];

        $this->mergeManagerMock->expects($this->once())
            ->method('mergeItems')
            ->willReturn($itemListResult);

        $this->saveProductList($itemListResult, $listMock);
