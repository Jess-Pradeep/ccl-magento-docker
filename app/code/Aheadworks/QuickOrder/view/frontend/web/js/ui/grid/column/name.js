        ...
        */
        ...
        getProductAttributes:function (item) {
            ...
            if (typeof attributes[this.productTypeCustomOptionsIndex] !== "undefined") {
                customOptions = this._removeDownloadLink(attributes[this.productTypeCustomOptionsIndex]);
        ...
        /**
         * Remove links from custm options
         *
         * @param {Object} customOptions
         * @return {Object}
         * @private
         */
        _removeDownloadLink: function (customOptions) {
