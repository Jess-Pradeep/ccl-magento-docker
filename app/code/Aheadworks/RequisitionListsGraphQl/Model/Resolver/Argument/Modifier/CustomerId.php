...
namespace Aheadworks\RequisitionListsGraphQl\Model\Resolver\Argument\Modifier;
...
{
    /**
     * Added customer id to filter from context
     *
     * @param Field $field
    ...
    {
        $args['filter'][RequisitionListInterface::CUSTOMER_ID]['eq'] = (string)$context->getUserId();
