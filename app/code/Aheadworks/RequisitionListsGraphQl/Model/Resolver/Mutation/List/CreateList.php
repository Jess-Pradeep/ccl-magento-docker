...
class CreateList extends AbstractPrivateResolver
{
    /**
    ...
    public function __construct(
        private readonly RequisitionListInterfaceFactory $requisitionListInterfaceFactory,
    ...
    {
        $args['customer_id'] = $context->getUserId();
        ...
        return $this->requisitionListRepository->save($listObject);
    }
