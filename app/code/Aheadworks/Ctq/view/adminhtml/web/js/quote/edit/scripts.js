define([
    ...
    AwCtqQuote.prototype = {
        ...
        setCurrencyId : function(id){
            ...
            this.loadArea(['items', 'totals', 'order_totals', 'shipping_method'], true);
        },
         ...
         * @param price
         */
        setShippingMethod: function(method, price) {
            var data = {};

            data['shipping[shipping_method]'] = method;
            data['shipping[shipping_custom_price]'] = price;
            this.loadArea(['shipping_method', 'totals', 'order_totals',], true, data);
        },
        ...
        itemsOnchangeBind: function() {
            ...
            for(var i = 0; i < elems.length; i++) {
                if (!elems[i].bindOnchange && elems[i].className !== 'awctq_item_comment') {
        ...
        /**
         * On account group change handler
         */
        accountGroupChange: function () {
            this.loadArea(['data'], true, this.serializeData('combined-top-section').toObject());
        },

        /**
         * On account field change handler
         */
        accountFieldChange : function(){
            this.saveData(this.serializeData('combined-top-section'));
        },
