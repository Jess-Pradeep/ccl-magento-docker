define([
    ...
    $.widget('awctq.awCtqButtonControl', {
        ...
        _isValidForm: function () {
            ...
            this.replaceValidationMessages($(this.options.submitForm.formSelector));
         ...
         * @param {Element} form
         */
        replaceValidationMessages: function (form) {
            var qtyInput = form.find('.input-text.qty');

            if (qtyInput.length) {
                qtyInput.attr('data-msg-validate-zero-or-greater', $.mage.__("Please enter a positive number."));
                qtyInput.attr('data-msg-integer', $.mage.__("Please enter a positive and non-decimal number."));
            }
        },
