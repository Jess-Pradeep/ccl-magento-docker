...
use Aheadworks\Ctq\Controller\Adminhtml\Quote\Edit\PostDataProcessor\NegotiatedDiscount as DiscountProcessor;
use Aheadworks\Ctq\Controller\Adminhtml\Quote\Edit\PostDataProcessor\PriceVisibility as PriceVisibilityProcessor;
...
class PostDataProcessor
{
    ...
    private $processors = [
        ...
        'discount' => DiscountProcessor::class,
        'price_visibility' => PriceVisibilityProcessor::class
    ];
