...
class BuyerQuoteServiceTest extends TestCase
{
    ...
    /**
     * @var RequestQuoteInputInterfaceFactory|PHPUnit_Framework_MockObject_MockObject
     */
    private $quoteRequestInputFactoryMock;
    ...
    public function setUp(): void
    {
        ...
        $this->quoteRequestInputFactoryMock = $this->createMock(
            RequestQuoteInputInterfaceFactory::class
        );
        ...
        $this->service = $objectManager->getObject(
            ...
            [
                ...
                'requestInputFactory' => $this->quoteRequestInputFactoryMock
            ]
        );
    }
    ...
    public function testRequestQuote()
    {
        ...
        $cartExtensionsAttributesMock = $this->getMockForAbstractClass(
        ...
        $inputRequestMock = $this->createMock(RequestQuoteInputInterface::class);

        $this->quoteRequestInputFactoryMock
            ->expects($this->once())
            ->method('create')
            ->willReturn($inputRequestMock);
        $inputRequestMock->expects($this->once())
            ->method('setQuoteName')
            ->with($quoteName)
            ->willReturnSelf();
        $inputRequestMock->expects($this->once())
        ...
        $cartMock
            ...
            ->willReturnMap([
                ...
                ['setAwCtqIsNotRequireValidation', [true], $cartMock]
            ]);
        ...
        $this->expirationCalculatorMock
            ->expects($this->once())
            ->method('calculateReminderDate')
            ->willReturn($reminderDate);
        $this->expirationCalculatorMock
            ->expects($this->once())
