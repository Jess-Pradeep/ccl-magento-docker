...
class Config
{
    ...
    const XML_PATH_GENERAL_GET_MINIMUM_QUOTE_SUBTOTAL = 'aw_ctq/general/minimum_quote_subtotal';
    const XML_PATH_GENERAL_GET_MINIMUM_QUOTE_SUBTOTAL_MESSAGE = 'aw_ctq/general/minimum_quote_subtotal_message';
    ...
    const XML_PATH_GENERAL_IS_QUOTE_REQUEST_ALLOWED_FROM_CART = 'aw_ctq/general/is_quote_request_allowed_from_cart';
    ...
    const XML_PATH_PDF_OPTIONS_IS_PDF_ATTACHED_TO_EMAIL = 'aw_ctq/pdf_options/is_pdf_attached_to_email';
    const XML_PATH_SHIPPING_TITLE = 'shipping/cqt/title';
    /**#@-*/
    ...
    /**
     * Get Minimum Quote Subtotal
     *
     * @param int|null $websiteId
     * @return int
     */
    public function getMinimumQuoteSubtotal($websiteId = null)
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_GENERAL_GET_MINIMUM_QUOTE_SUBTOTAL,
            ScopeInterface::SCOPE_WEBSITE,
            $websiteId
        );
    }
    ...
    /**
     * Get Minimum Quote Subtotal Message
     *
     * @param int|null $websiteId
     * @return string
     */
    public function getMinimumQuoteSubtotalMessage($storeId = null)
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_GENERAL_GET_MINIMUM_QUOTE_SUBTOTAL_MESSAGE,
    ...
    /**
     * Check if customer group is allowed to request a quote
     *
     * @param int $customerGroupId
     * @param int|null $websiteId
     * @return bool
     */
    public function isEnabledForCustomerGroupToRequestQuote($customerGroupId, $websiteId = null)
    {
    ...
    /**
     * Is quote request allowed from cart
     *
     * @param int|null $websiteId
     * @return bool
     */
    public function isQuoteRequestAllowedFromCart($websiteId = null)
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_GENERAL_IS_QUOTE_REQUEST_ALLOWED_FROM_CART,
            ScopeInterface::SCOPE_WEBSITE,
            $websiteId
        );
    }
    ...
    public function getAllowFileExtensions($storeId = null)
    {
        ...
        return empty($extensions) ? [] : explode(',', (string)$extensions);
    }
    ...
    public function getRecipientsEmail($storeId = null)
    {
        ...
        return empty($recipients) ? [] : array_map('trim', array_filter(explode(',', (string)$recipients)));
    }
    ...
    /**
     * Check if pdf must be attached to email
     *
     * @return bool
     */
    public function isPdfAttachedToEmail()
    {
        return $this->scopeConfig->isSetFlag(self::XML_PATH_PDF_OPTIONS_IS_PDF_ATTACHED_TO_EMAIL);
    }
     ...
     * @return string
     */
    public function getShippingTitle(?int $storeId): string
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_PATH_SHIPPING_TITLE,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
