...
class MergeProcessor
{
    ...
    public function mergeQuotes()
    {
        try {
            ...
            if (!$customerQuote) {
                $quoteListId = $this->quoteListManagement->createQuoteListForCustomer(
                    $this->customerSession->getCustomerId()
                );
                $customerQuote = $this->quoteListManagement->getQuoteList($quoteListId);
            }
            ...
            if ($customerQuote && $customerQuote->getId()) {
