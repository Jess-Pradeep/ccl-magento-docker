define([
    ...
    return Element.extend({
        ...
        isVisible: function (data = null) {
            if ((this.dataType === 'due_date' || this.dataType === 'days') && data && !this.getValue(data)) {
                this.visible = false;
            }
        ...
        formatValue: function (value, type, isConverted) {
            ...
            switch (type) {
                ...
                case 'days':
                    if (value) {
                        var countDays = Number(value * 1).toFixed(0);
                        formattedValue = String(countDays) + ' Days';
                    } else {
