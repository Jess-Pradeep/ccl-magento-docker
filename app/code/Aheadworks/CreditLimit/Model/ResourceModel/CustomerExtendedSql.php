...
class CustomerExtendedSql
{
    ...
    public function applyColumns($sqlSelect)
    {
        ...
        $columns = [
            ...
            'is_allowed_to_exceed' => 'cl_customer_value.is_allowed_to_exceed',
            ...
            SummaryInterface::PAYMENT_PERIOD => 'cl_customer_value.payment_period',
            SummaryInterface::DUE_DATE => 'cl_customer_value.due_date',
            SummaryInterface::LAST_DUE_DATE => 'cl_customer_value.last_due_date',
            SummaryInterface::NEGATIVE_BALANCE_DATE => 'cl_customer_value.negative_balance_date'
        ];
