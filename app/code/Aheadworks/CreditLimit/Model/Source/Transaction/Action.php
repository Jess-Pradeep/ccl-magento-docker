...
class Action implements OptionSourceInterface
{
    ...
    const CREDIT_BALANCE_UPDATED_BY_UNIT = 'credit_balance_updated_by_unit';
    const CREDIT_BALANCE_REFUNDED_BY_UNIT = 'credit_balance_refunded_by_unit';
    ...
    public function toOptionArray()
    {
        return [
            ...
            [
                ...
                'label' => __('Updated by Admin')
            ],
            [
                'value' => self::CREDIT_BALANCE_UPDATED_BY_UNIT,
                'label' => __('Updated by Customer')
            ],
            [
                'value' => self::CREDIT_BALANCE_REFUNDED_BY_UNIT,
                'label' => __('Refunded Credit')
            ],
            [
