...
class Delete extends AuthorizedCompanyUserResolver implements ResolverInterface
{
    /**
     * @param CompanyUserProvider $companyUserProvider
     * @param CommandInterface $deleteDomainCommand
     * @param CompanyDomainRepositoryInterface $domainRepository
     */
    public function __construct(
        CompanyUserProvider $companyUserProvider,
        private readonly CommandInterface $deleteDomainCommand,
    ...
    public function resolve(
        ...
        return $this->deleteDomainCommand->execute($args);
    }
}
