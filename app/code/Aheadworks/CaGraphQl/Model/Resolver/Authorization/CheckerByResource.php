...
class CheckerByResource extends AuthorizedCompanyUserResolver implements ResolverInterface
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, ?array $value = null, ?array $args = null): bool
    {
        ...
        return $this->authorizationManagement->isAllowedByResource($args['resource']);
    }
}
